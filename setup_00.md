...
----------
The general aim of this guide is to give some cues and clues for learning the fundamentals of "how software is done" at [RENCI](http://renci.org)'s [iRODS Consortium](http://irods.org), where the core development and engineering work is done on **iRODS** (Ithe *integrated Rule-Oriented Data System*) and some of its peripheral parts (whether plugins or contributions from outside teams that might be in the process of integration).  The author of this guide started not very long ago on the iRODS team and, in the process of learning and adaptation, relied pretty heavily on the time and attention of some senior team members -- hence the need to write some "developer orientation" docs for others who might also find themselves in the same lucky position of becoming part the team!  If you're reading this because you have joined the core iRODS dev team; if you're finding it has potential applications for you; or, if you simply enjoy some educational playing-around with open source software - you still might find it helpful to peruse or work through some of the instructions included here.

Whatever the case, dear reader, the author hopes you find the process of satiating your curiosity to be joyous, and your development experience with iRODS to be successful!
